...
/**
 * S07 - Monitoring (Annotation / Declarative)
 * Same composed workflow as {@link S07_ComposingPatterns_Annotation}, with
 * an {@link AgentMonitor} attached through {@link AgentListenerSupplier} on
 * both the loop and the outer sequence so the resulting trace can be
 * rendered to HTML.
 */
public class S07_Monitoring_Annotation {
    ...
    void main() {
        ...
        var hq = AgenticServices.createAgenticSystem(RebellionHQ.class, model);
